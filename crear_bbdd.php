...
$sql = "INSERT INTO usuarios (nombre, apellidos, email, password, tipo_usuario) 
                VALUES ('Carlos', 'Gonzalez Garcia', 'administrador@pisada_firme.com', 'Admin1234', 'administrador')";
...
$sql = "INSERT INTO usuarios (nombre, apellidos, email, password, tipo_usuario) 
                VALUES ('Pedro', 'Ramos Fernandez', 'cliente@pisada_firme.com', 'Client4321', 'cliente')";
